...
var Slider = React.createClass({displayName: "Slider",
    ...
    render: function() {
        ...
        return (
                React.createElement("div", {ref: "slider", className: SliderClass, style: this.SliderStyle, title: title}, 
                    React.createElement("div", {className: "RateBg", style: this.RateBgStyle}), 
                    React.createElement("div", {className: "Rate", style: RateStyle}), 
                    React.createElement("div", {style: this.TouchStyle, onClick: this.onClick}), 
                    React.createElement("label", {ref: "button", className: ButtonClass, style: ButtonStyle, onMouseDown: this.onMouseDown})
                ) 
        );
    }
});
ReactDOM.render(
    React.createElement(Slider, {rate: 0, length: 400, outRadius: 15, inRadius: 5}),
    document.getElementById('example01')
);
ReactDOM.render(
    React.createElement(Slider, {rate: 0.5}),
    document.getElementById('example02')
);
ReactDOM.render(
    React.createElement(Slider, {rate: 0, enable: false}),
